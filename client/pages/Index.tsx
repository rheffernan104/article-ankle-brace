          ...
          <article className="space-y-12">
            ...
            <section className="space-y-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-semibold text-foreground">4.7 / 5 stars</span>
              </div>
            ...
            <section className="space-y-6 rounded-2xl border border-border bg-secondary/50 p-6 md:p-8">
              ...
              <p className="text-base leading-relaxed text-muted-foreground">
                Nearly 1 in 10 people will experience plantar fasciitis in their lifetime. And chronic ankle instability? It affects up to 40% of people who've ever had a sprain—meaning millions are walking around on a "wobbly" ankle that could give way at any moment.
              </p>
            </section>
            ...
            <section className="grid gap-4 rounded-2xl bg-secondary p-6 sm:grid-cols-2 md:grid-cols-2">
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-primary">70% Failure Rate</p>
                <p className="mt-2 text-base font-semibold text-foreground">Of people using standard compression-only sleeves report incomplete pain relief</p>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-wider text-primary">Root Cause Problem</p>
                <p className="mt-2 text-base font-semibold text-foreground">Most supports do only ONE job when feet need THREE</p>
              </div>
            </section>
            ...
            <section className="space-y-6">
              ...
              <p className="text-base leading-relaxed text-muted-foreground">
                Your foot and ankle work as a unified biomechanical system. The plantar fascia (the thick band running along your heel and arch), your ankle ligaments, and the surrounding muscles all depend on each other for stability, circulation, and pain-free movement.
              </p>
              ...
              <ul className="space-y-4 text-base text-muted-foreground">
                <li className="flex items-start gap-3">
                  ...
                  <span><span className="font-semibold text-foreground">Compression-only sleeves</span> squeeze your foot to reduce swelling—but they don't stabilize your ankle or support your arch. So your ligaments keep straining with every step. You get temporary relief, then the pain comes right back.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-primary flex-none" />
                  <span><span className="font-semibold text-foreground">Rigid ankle braces</span> lock your joint in place for stability—but they're so bulky you can't wear them in normal shoes. Plus, they restrict circulation, which slows healing and makes swelling worse.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-primary flex-none" />
            ...
            <section className="space-y-6 rounded-2xl border border-border bg-primary/5 p-6 md:p-8">
              <blockquote className="text-base italic leading-relaxed text-muted-foreground">
                "The biggest mistake people make is treating foot pain and ankle instability as separate problems. In reality, they're connected. If you only compress without stabilizing��or stabilize without improving circulation—you're only addressing half the issue. That's why so many patients say 'nothing works.'"
              </blockquote>
              <p className="text-sm font-semibold text-foreground">— Dr. Michael Chen, Physical Therapist</p>
            </section>

            {/* Three Things Your Body Needs */}
            <section className="space-y-6">
              <p className="text-base leading-relaxed text-muted-foreground font-semibold text-foreground">
                Translation? Your body needs three things simultaneously to heal and feel better:
              </p>
              ...
              <p className="text-base leading-relaxed text-muted-foreground">
                Most products give you one. Maybe two. But never all three. And that's exactly why you've tried "everything" and still wake up wincing—or why you're scanning the pavement for cracks before every step—or why your feet throb so badly by 3 PM you want to sit down and cry.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground font-semibold text-foreground">
            ...
            <section className="space-y-6 rounded-2xl border border-border bg-secondary/50 p-6 md:p-8">
              ...
              <p className="text-base leading-relaxed text-muted-foreground">
                Think of it like this: if your ankle's natural "support cables" are frayed and weak, Orthos becomes a second set of tendons—holding everything in the right position so your body can finally heal instead of re-injure.
              </p>
            </section>
              ...
              <div className="space-y-8">
                <div className="grid gap-8 md:grid-cols-2 md:items-center">
                  ...
                  <ul className="space-y-3 text-base text-muted-foreground">
                    <li className="flex items-start gap-3">
                      ...
                      <span>Boosts circulation by up to 30%—bringing fresh oxygen to injured tissues so they can heal faster</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="mt-1 h-5 w-5 text-primary flex-none" />
                      <span>Reduces inflammation and swelling throughout the day (not just for an hour after you put it on)</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <CheckCircle2 className="mt-1 h-5 w-5 text-primary flex-none" />
                ...
                <div className="grid gap-8 md:grid-cols-2 md:items-center md:grid-flow-dense">
                  <div className="md:order-2 overflow-hidden rounded-2xl max-w-sm">
                    <img src="https://cdn.builder.io/api/v1/image/assets%2Fbdd0323bbd62433fb2b19a5850550dd6%2F697cfe2c7fb2422c81541f08ee6bc20a?format=webp&width=800" alt="Adjustable X-strap ankle stabilizers" className="w-full h-full object-cover" />
                  </div>
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-4 text-base leading-relaxed text-muted-foreground">
                <div>
                  <p className="font-semibold text-foreground">In the first 60 seconds:</p>
                  <p>The compression hugs your foot. Your ankle feels held—not restricted, but supported. You notice it, but it's not uncomfortable. It's like… your foot just got a confidence boost.</p>
                </div>
                <div>
                  <p className="font-semibold text-foreground">After 10 minutes:</p>
                  <p>You realize you're not thinking about your ankle anymore. You take the stairs without checking for the railing first. You step off a curb without that split-second hesitation.</p>
                </div>
                <div>
                  <p className="font-semibold text-foreground">By hour 4:</p>
                  <p>Your feet don't hurt. Not even a little. You're standing, walking, moving—and it's just… automatic. No throbbing. No swelling creeping in. No mental checklist of "where can I sit down?"</p>
                </div>
                <div>
                  <p className="font-semibold text-foreground">By the end of the day:</p>
                  <p>You get home, take off your shoes, and your feet don't look like swollen balloons. There's no angry red marks from tight elastic. No numbness. No relief-followed-by-regret. You just… feel normal. Like your feet work the way they're supposed to. Like you're not stuck with "bad feet." Like you're just… you. Moving. Living. Not limping.</p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-6">
              ...
              <ul className="space-y-3 text-base text-muted-foreground">
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-primary flex-none" />
                  <span>Every time your ankle wobbles on uneven ground, those ligaments strain a little more.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-primary flex-none" />
                  <span>Every time your arch collapses because there's no support, that plantar fascia pulls and tears at a microscopic level.</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="mt-1 h-2 w-2 rounded-full bg-primary flex-none" />
                  <span>Every time circulation gets restricted by too-tight elastic, inflammation builds up instead of flushing out.</span>
                </li>
              </ul>
              <p className="text-base leading-relaxed text-muted-foreground">
                It's not dramatic. It's not sudden. But it's cumulative. And after months or years of this? Your "mild ankle issue" becomes chronic instability. Your "occasional heel pain" becomes plantar fasciitis that won't quit. Your "a little swelling by evening" becomes painful edema that makes you want to elevate your feet the second you get home.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground font-semibold text-foreground">
                Here's the good news:
              </p>
              <p className="text-base leading-relaxed text-muted-foreground">
                Your body wants to heal. It's designed to heal. But it can't do that while it's being re-injured. Orthos stops the cycle. By stabilizing your ankle, supporting your arch, and improving circulation all at once, it creates the conditions your body needs to actually recover—not just mask symptoms.
              </p>
            </section>
            ...
            <section className="space-y-8">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground">
                    Orthos uses a multi-layer knit engineered to maintain consistent compression over hundreds of wears. It's the same fabric grade used in clinical compression garments prescribed by vascular specialists. <span className="font-semibold text-foreground">What that means:</span> The support doesn't fade. The sleeve doesn't stretch out. It works the same on Day 1 and Day 100.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground">
                    Orthos is designed to be thin enough to fit inside dress shoes, sneakers, work boots—even flats. The compression sleeve hugs your foot like a second skin, and the straps sit flat against your ankle (no bulky buckles or hard plastic stays). <span className="font-semibold text-foreground">What that means:</span> You're not stuck wearing one pair of oversized shoes. You can wear Orthos with the footwear you already own—and no one even knows it's there.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground mb-3">
                    With Orthos, you control the fit. The figure-8 straps use industrial-strength Velcro that holds exactly where you position it—so you can dial in the perfect amount of support for your activity level and pain severity. Need maximum stability for a long hike? Tighten the straps. Just want gentle support for a casual walk? Loosen them slightly. It's like having a sports brace and a compression sock in one—without the bulk. <span className="font-semibold text-foreground">What that means:</span> You're not stuck with a "medium" that's too tight or too loose. You get your perfect fit, every single time.
                  </p>
                  <p className="text-base leading-relaxed text-muted-foreground">
                    Not sure about sizing? We include a detailed fit guide with every order—and if you're between sizes or need an exchange, our 30-day guarantee makes it effortless. No hassle. No fees. Just the right fit.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-base leading-relaxed text-muted-foreground">
                    That's because most compression sleeves have a smooth interior that slides against your skin—especially when you sweat. Orthos has silicone grip strips at the top cuff and heel cup. These tiny, soft ridges create just enough friction to keep the sleeve anchored—without digging in or feeling sticky. <span className="font-semibold text-foreground">What that means:</span> You put it on once in the morning. It stays put. You're not yanking it up every 20 minutes or feeling it bunch under your heel.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-6">
              ...
              <p className="text-base leading-relaxed text-muted-foreground">
                This is why so many people with chronic foot pain also develop knee pain or hip discomfort. It's not separate issues. It's a cascade effect from one misaligned joint.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground">
                Orthos restores neutral alignment. The X-Straps guide your ankle into the position it's supposed to be in—the position where ligaments, tendons, and muscles can function optimally. And when your ankle is aligned? Your knee tracks correctly. Your hip doesn't overcompensate. Your gait normalizes.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground font-semibold text-foreground">
                You're not just fixing your foot. You're protecting your whole body.
              </p>
            </section>
                ...
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="rounded-3xl bg-white overflow-hidden shadow-lg ring-1 ring-border/60 flex flex-col">
                    <div className="overflow-hidden">
                      <img
                        src={index === 0 ? "https://cdn.builder.io/api/v1/image/assets%2Fbdd0323bbd62433fb2b19a5850550dd6%2F6a144f49f2ac4274b120251dedfc9d05?format=webp&width=800" : index === 1 ? "https://cdn.builder.io/api/v1/image/assets%2Fbdd0323bbd62433fb2b19a5850550dd6%2F6205e190168149d79460bfec4147b7e9?format=webp&width=800" : "https://cdn.builder.io/api/v1/image/assets%2Fbdd0323bbd62433fb2b19a5850550dd6%2F9762d70010314abd8a92318fa6be30e8?format=webp&width=800"}
            ...
            <section className="space-y-6">
              ...
              <ol className="space-y-3 text-base text-muted-foreground list-decimal list-inside">
                ...
                <li>We're not interested in keeping your money if Orthos doesn't help you. We only win if you win. And if you need to exchange sizes? That's covered too. We want you to have the right fit—not just a fit.</li>
              </ol>
            </section>
            ...
            <section className="space-y-6 rounded-2xl border-2 border-accent bg-accent/10 p-6 md:p-8">
              ...
              <p className="text-base leading-relaxed text-muted-foreground">
                Our last restock sold out in 11 days. And based on current order volume, we're projecting this batch will be gone within the next 7-10 days.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground">
                We're not saying this to create fake urgency. We're saying it because we don't want you to come back next week and see "Out of Stock" on the page.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground">
                If you're ready to stop calculating every step… if you're ready to walk without that constant background throb… if you're ready to feel like yourself again… Now is the time.
              </p>
            </section>
            ...
            <section className="space-y-6">
              <p className="text-base leading-relaxed text-muted-foreground">
                Because here's the truth: You can keep doing what you've been doing. Keep hoping the pain goes away on its own. Keep buying cheap sleeves that slide down or rigid braces you can't actually wear.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground">
                Or you can try something different. Something built specifically for people who've tried everything else. Something backed by a guarantee that removes all the risk.
              </p>
              <p className="text-base leading-relaxed text-muted-foreground font-semibold text-foreground">
            ...
            <section className="space-y-6">
              <ul className="space-y-4 text-base text-muted-foreground">
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-1 h-5 w-5 text-primary flex-none" />
                  <span>Adjustable for your perfect fit (with sizing guide included)</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-1 h-5 w-5 text-primary flex-none" />
                ...
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-1 h-5 w-5 text-primary flex-none" />
                  <span>Works for plantar fasciitis, ankle instability, and swelling</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle2 className="mt-1 h-5 w-5 text-primary flex-none" />
            ...
            <section className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="rounded-2xl border border-border p-6">
                  <h3 className="font-semibold text-foreground mb-2">"Will this work for my specific condition?"</h3>
                  <p className="text-base text-muted-foreground">Orthos is designed for plantar fasciitis, ankle instability, general swelling, and recovery from sprains. If you're unsure, consult your healthcare provider—and remember, you have 30 days to test it risk-free.</p>
                </div>

                <div className="rounded-2xl border border-border p-6">
                  <h3 className="font-semibold text-foreground mb-2">"How do I know what size to order?"</h3>
                  <p className="text-base text-muted-foreground">We include a detailed sizing guide, and if you need to exchange, it's completely hassle-free under our guarantee.</p>
                </div>

                <div className="rounded-2xl border border-border p-6">
                  <h3 className="font-semibold text-foreground mb-2">"Can I wear this during exercise?"</h3>
                  <p className="text-base text-muted-foreground">Yes. Many customers wear Orthos during workouts, runs, and sports. The adjustable straps let you dial in the support level you need.</p>
                </div>

                <div className="rounded-2xl border border-border p-6">
                  <h3 className="font-semibold text-foreground mb-2">"How long until I feel the results?"</h3>
                  <p className="text-base text-muted-foreground">Many users report feeling more stable and supported within the first hour. Pain reduction varies—some notice improvement within days, others within 1-2 weeks of consistent wear.</p>
                </div>
              </div>
            </section>
            ...
            <section className="text-xs text-muted-foreground italic">
              <p>
                This article is for informational purposes only and is not intended as medical advice. Always consult your healthcare provider before starting any new treatment. Individual results may vary.
              </p>
            </section>
          </article>
